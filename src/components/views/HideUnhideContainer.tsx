...
export default function HideUnhideContainer() {
  ...
  const [activeTab, setActiveTab] = useState<'hide' | 'unhide' | 'history' | 'requests'>(
  ...
  const tabs = [
    ...
    { id: 'requests', label: t.requests, icon: Inbox, roles: ["Technical Back Office", "Manager", "Super Visor", "Restaurants", "Area Manager"] },
    ...
    <div className="space-y-8">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {activeTab === 'requests' && <PendingRequestsView filterType="hide_unhide" />}
        </motion.div>
      </AnimatePresence>
    </div>
  );
