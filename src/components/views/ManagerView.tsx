...
import { Plus, UserPlus, Shield, Globe, Settings, History, Trash2, Edit2, Check, X, User as UserIcon, Lock, Briefcase, MapPin, Building2 } from 'lucide-react';
...
export default function ManagerView({ activeTab }: { activeTab: string }) {
  ...
  const handleDeleteField = async (fieldId: number) => {
    if (!confirm('Are you sure you want to delete this field? This will remove all associated data.')) return;
    const token = localStorage.getItem('token');
